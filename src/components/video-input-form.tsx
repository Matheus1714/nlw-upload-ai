...
export function VideoInputForm(props: VideoInputFormProps){
    ...
    async function handleUploadVideo(event: FormEvent<HTMLFormElement>) {
        ...
        const audioFile = await convertVideioToAudio(videoFile)
    ...
    return (
        <form className='space-y-6' onSubmit={handleUploadVideo}>
            ...
            <input type='file' id="video" accept='video/mp4' className='sr-only' onChange={handleFileSected}/>

            <Separator />

            <div className='space-y-2'>
            <Label htmlFor='transcription_prompt'>Propt de transcrição</Label>
            <Textarea
                ref={promptInputRef}
